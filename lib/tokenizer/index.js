...
Tokenizer.prototype.getNextToken = function () {
    while (!this.tokenQueue.length)
        this[this.state](this.preprocessor.consume());
...
Tokenizer.prototype._lookahead = function () {
    var cp = this.preprocessor.consume();
...
Tokenizer.prototype._consumeNumericEntity = function (isHex) {
    ...
    do {
        digits += toChar(this.preprocessor.consume());
        nextCp = this._lookahead();
    } while (nextCp !== $.EOF && isDigit(nextCp, isHex));

    if (this._lookahead() === $.SEMICOLON)
        this.preprocessor.consume();
...
Tokenizer.prototype._consumeNamedEntity = function (startCp, inAttr) {
    ...
    for (; leaf && cp !== $.EOF; cp = this.preprocessor.consume(), consumedCount++, leaf = leaf.l && leaf.l[cp]) {
        if (leaf.c) {
