...
//SAParser
var SAParser = module.exports = function (handlers) {
    this.handlers = {
...
//API
SAParser.prototype.parse = function (html) {
    var token = null;
...
//Internals
SAParser.prototype._handleToken = function (token) {
...
SAParser.prototype._reset = function (html) {
    this.tokenizerProxy = new TokenizerProxy(html);
    this.pendingText = null;
};

SAParser.prototype._emitPendingText = function () {
