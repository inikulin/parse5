...
exports.assign = function (tokenizer) {
    ...
    tokenizer._attachCurrentLocationInfo = function (token) {
        token.location = {
            start: this.preprocessor.pos,
            end: -1
        };
    };
    ...
    tokenizer._createAttr = function (attrNameFirstCh) {
        ...
        this._attachCurrentLocationInfo(this.currentAttr);
    };

    tokenizer._leaveAttrName = function (toState) {
        this.currentAttr.location.end = this.preprocessor.pos;
