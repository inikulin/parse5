...
//Tokenizer
var Tokenizer = module.exports = function (html, disableHtmlEntitiesDecoding) {
    this.disableHtmlEntitiesDecoding = disableHtmlEntitiesDecoding;
...
Tokenizer.prototype._consumeCharacterReference = function (startCp, inAttr) {
    if (this.disableHtmlEntitiesDecoding || isWhitespace(startCp) || startCp === $.GREATER_THAN_SIGN ||
