...
ParserController.prototype._setSuspended = function (suspend) {
    if(this.suspended && suspend)
        throw 'parse5: Parser was already suspended. Please, check your control flow logic.';

    else if(!this.suspended && !suspend)
        throw 'parse5: Parser was already resumed. Please, check your control flow logic.';
