...
exports.isElementInMathMLTextIntegrationPoint = function (element) {
    var tn = element.tagName;

    return element.namespaceURI === NAMESPACES.MATHML &&
           (tn === $.MI || tn === $.MO || tn === $.MN || tn === $.MS || tn === $.MTEXT);
};

exports.isElementInHtmlIntegrationPoint = function (element) {
    var tn = element.tagName,
