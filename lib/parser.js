...
Parser.prototype._shouldProcessTokenInForeignContent = function (token) {
    ...
    if (this._isMathMLTextIntegrationPoint(current) &&
    ...
    if (this._isHtmlIntegrationPoint(current) && (token.type === Tokenizer.START_TAG_TOKEN ||
