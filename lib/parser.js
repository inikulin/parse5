...
IM_[IN_HEAD_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = whitespaceCharacterInHead;
...
IM_[AFTER_HEAD_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = whitespaceCharacterAfterHead;
...
IM_[TEXT_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = characterInText;
...
IM_[IN_COLUMN_GROUP_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = whitespaceCharacterInColumnGroup;
...
IM_[IN_SELECT_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = characterInSelect;
...
IM_[IN_SELECT_IN_TABLE_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = characterInSelect;
...
IM_[IN_FRAMESET_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = whitespaceCharacterInFrameset;
...
IM_[AFTER_FRAMESET_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = whitespaceCharacterAfterFrameset;
...
FC_[Tokenizer.WHITESPACE_CHARACTER_TOKEN] = whitespaceCharacterInForeignContent;
...
//TODO basic handler for doctypes, eofs and characters
...
//------------------------------------------------------------------
function whitespaceCharacterInHead(p, token) {
...
//------------------------------------------------------------------
function whitespaceCharacterAfterHead(p, token) {
    p._insertCharacters(token);
}
...
//------------------------------------------------------------------
function whitespaceCharacterInColumnGroup(p, token) {
    p._insertCharacters(token);
}
...
//------------------------------------------------------------------
function whitespaceCharacterInFrameset(p, token) {
    p._insertCharacters(token);
}
...
//------------------------------------------------------------------
function whitespaceCharacterAfterFrameset(p, token) {
    p._insertCharacters(token);
}
...
function whitespaceCharacterInForeignContent(p, token) {
    p._insertCharacters(token);
}
