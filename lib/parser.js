...
Parser.prototype.parse = function () {
    while (!this.stopped)
        this._processToken(this.tokenizer.getNextToken());
...
Parser.prototype._processTokenInCurrentInsertionMode = function (token) {
...
function initialModeDefaultHandler(p, token) {
    ...
    p._processTokenInCurrentInsertionMode(token);
}
