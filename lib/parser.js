...
startTagInBodyProcessors[$.BODY] = function (p, token) {
    ...
    var bodyElement = p.openElements.tryPeekProperlyInsertedBodyElement();
...
startTagInBodyProcessors[$.FRAMESET] = function (p, token) {
    ...
    if (p.openElements.tryPeekProperlyInsertedBodyElement()) {
...
startTagInBodyProcessors[$.DT] = function (p, token) {
    ...
    for (var i = p.openElements.length; i >= 0; i--) {
