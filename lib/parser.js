...
_[IN_CAPTION_MODE] = {};
_[IN_CAPTION_MODE][Tokenizer.CHARACTER_TOKEN] =
_[IN_CAPTION_MODE][Tokenizer.COMMENT_TOKEN] =
_[IN_CAPTION_MODE][Tokenizer.DOCTYPE_TOKEN] = inCaptionModeDefaultHandler;
_[IN_CAPTION_MODE][Tokenizer.START_TAG_TOKEN] = startTagInCaption;
_[IN_CAPTION_MODE][Tokenizer.END_TAG_TOKEN] = endTagInCaption;
_[IN_CAPTION_MODE][Tokenizer.EOF_TOKEN] = inCaptionModeDefaultHandler;
...
_[IN_TABLE_BODY_MODE][Tokenizer.COMMENT_TOKEN] =
_[IN_TABLE_BODY_MODE][Tokenizer.DOCTYPE_TOKEN] = inTableBodyDefaultHandler;
_[IN_TABLE_BODY_MODE][Tokenizer.START_TAG_TOKEN] = startTagInTableBody;
_[IN_TABLE_BODY_MODE][Tokenizer.END_TAG_TOKEN] = endTagInTableBody;
_[IN_TABLE_BODY_MODE][Tokenizer.EOF_TOKEN] = inTableBodyDefaultHandler;

_[IN_ROW_MODE] = {};
_[IN_ROW_MODE][Tokenizer.CHARACTER_TOKEN] =
_[IN_ROW_MODE][Tokenizer.COMMENT_TOKEN] =
_[IN_ROW_MODE][Tokenizer.DOCTYPE_TOKEN] = inRowModeDefaultHandler;
_[IN_ROW_MODE][Tokenizer.START_TAG_TOKEN] = startTagInRow;
_[IN_ROW_MODE][Tokenizer.END_TAG_TOKEN] = endTagInRow;
_[IN_ROW_MODE][Tokenizer.EOF_TOKEN] = inRowModeDefaultHandler;
...
function characterInTable(p, token) {
    var curOpenElementTn = p.openElements.current.tagName;

    if (curOpenElementTn === $.TABLE || curOpenElementTn === $.TBODY || curOpenElementTn === $.TFOOT ||
        curOpenElementTn === $.THEAD || curOpenElementTn === $.TR) {
...
function startTagInCaption(o, token) {
    ...
    if (tn === $.CAPTION || tn === $.COL || tn === $.COLGROUP || tn === $.TBODY ||
        ...
        inCaptionModeDefaultHandler(p, token);
}
...
function endTagInCaption(p, token) {
    ...
    if (tn === $.CAPTION) {
        if (p.openElements.hasInTableScope($.CAPTION)) {
            ...
            if (p.openElements.current.tagName !== $.CAPTION)
                p._err('Parse error');
...
function inCaptionModeDefaultHandler(p, token) {
    _[IN_BODY_MODE][token.type](p, token);
}
...
function inTableBodyDefaultHandler(p, token) {
    _[IN_TABLE_MODE][token.type](p, token);
}
...
function startTagInRow(p, token) {
    ...
    if (tn === $.TH || tn === $.TD) {
        ...
        inRowModeDefaultHandler(p, token);
}
...
function inRowModeDefaultHandler(p, token) {
    _[IN_TABLE_MODE][token.type](p, token);
}
...
Parser.prototype._insertFakeHtmlElement = function () {
    var element = this.treeBuilder.createElement($.HTML, [], html.NAMESPACES.HTML);
    this.treeBuilder.appendNode(this.openElements.current, element);
    this.openElements.push(element);
};
...
Parser.prototype._generateImpliedEndTags = function () {
    //TODO: should we check element existense here?
