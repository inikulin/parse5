...
IM_[INITIAL_MODE] = {};
IM_[INITIAL_MODE][Tokenizer.CHARACTER_TOKEN] =
IM_[INITIAL_MODE][Tokenizer.NULL_CHARACTER_TOKEN] = tokenInInitialMode;
IM_[INITIAL_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = ignoreToken;
IM_[INITIAL_MODE][Tokenizer.COMMENT_TOKEN] = appendComment;
...
IM_[INITIAL_MODE][Tokenizer.EOF_TOKEN] = tokenInInitialMode;

IM_[BEFORE_HTML_MODE] = {};
IM_[BEFORE_HTML_MODE][Tokenizer.CHARACTER_TOKEN] =
IM_[BEFORE_HTML_MODE][Tokenizer.NULL_CHARACTER_TOKEN] = tokenBeforeHtml;
IM_[BEFORE_HTML_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = ignoreToken;
IM_[BEFORE_HTML_MODE][Tokenizer.COMMENT_TOKEN] = appendComment;
IM_[BEFORE_HTML_MODE][Tokenizer.DOCTYPE_TOKEN] = addMisplacedDoctypeError;
...
IM_[BEFORE_HTML_MODE][Tokenizer.EOF_TOKEN] = tokenBeforeHtml;

IM_[BEFORE_HEAD_MODE] = {};
IM_[BEFORE_HEAD_MODE][Tokenizer.CHARACTER_TOKEN] =
IM_[BEFORE_HEAD_MODE][Tokenizer.NULL_CHARACTER_TOKEN] = tokenBeforeHead;
IM_[BEFORE_HEAD_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = ignoreToken;
IM_[BEFORE_HEAD_MODE][Tokenizer.COMMENT_TOKEN] = appendComment;
IM_[BEFORE_HEAD_MODE][Tokenizer.DOCTYPE_TOKEN] = addMisplacedDoctypeError;
...
IM_[BEFORE_HEAD_MODE][Tokenizer.EOF_TOKEN] = tokenBeforeHead;

IM_[IN_HEAD_MODE] = {};
IM_[IN_HEAD_MODE][Tokenizer.CHARACTER_TOKEN] =
IM_[IN_HEAD_MODE][Tokenizer.NULL_CHARACTER_TOKEN] = tokenInHead;
IM_[IN_HEAD_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = insertCharacters;
IM_[IN_HEAD_MODE][Tokenizer.COMMENT_TOKEN] = appendComment;
IM_[IN_HEAD_MODE][Tokenizer.DOCTYPE_TOKEN] = addMisplacedDoctypeError;
IM_[IN_HEAD_MODE][Tokenizer.START_TAG_TOKEN] = startTagInHead;
IM_[IN_HEAD_MODE][Tokenizer.END_TAG_TOKEN] = endTagInHead;
IM_[IN_HEAD_MODE][Tokenizer.EOF_TOKEN] = tokenInHead;

IM_[AFTER_HEAD_MODE] = {};
IM_[AFTER_HEAD_MODE][Tokenizer.CHARACTER_TOKEN] =
IM_[AFTER_HEAD_MODE][Tokenizer.NULL_CHARACTER_TOKEN] = tokenAfterHead;
IM_[AFTER_HEAD_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = insertCharacters;
IM_[AFTER_HEAD_MODE][Tokenizer.COMMENT_TOKEN] = appendComment;
IM_[AFTER_HEAD_MODE][Tokenizer.DOCTYPE_TOKEN] = addMisplacedDoctypeError;
...
IM_[AFTER_HEAD_MODE][Tokenizer.EOF_TOKEN] = tokenAfterHead;

IM_[IN_BODY_MODE] = {};
IM_[IN_BODY_MODE][Tokenizer.CHARACTER_TOKEN] = characterInBody;
IM_[IN_BODY_MODE][Tokenizer.NULL_CHARACTER_TOKEN] = nullCharacterInBody;
IM_[IN_BODY_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = whitespaceCharacterInBody;
IM_[IN_BODY_MODE][Tokenizer.COMMENT_TOKEN] = appendComment;
IM_[IN_BODY_MODE][Tokenizer.DOCTYPE_TOKEN] = addMisplacedDoctypeError;
...
IM_[TEXT_MODE] = {};
IM_[TEXT_MODE][Tokenizer.CHARACTER_TOKEN] =
IM_[TEXT_MODE][Tokenizer.NULL_CHARACTER_TOKEN] =
IM_[TEXT_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = insertCharacters;
...
IM_[IN_TABLE_MODE] = {};
IM_[IN_TABLE_MODE][Tokenizer.CHARACTER_TOKEN] =
IM_[IN_TABLE_MODE][Tokenizer.NULL_CHARACTER_TOKEN] =
IM_[IN_TABLE_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = characterInTable;
IM_[IN_TABLE_MODE][Tokenizer.COMMENT_TOKEN] = appendComment;
IM_[IN_TABLE_MODE][Tokenizer.DOCTYPE_TOKEN] = addMisplacedDoctypeError;
IM_[IN_TABLE_MODE][Tokenizer.START_TAG_TOKEN] = startTagInTable;
IM_[IN_TABLE_MODE][Tokenizer.END_TAG_TOKEN] = endTagInTable;
IM_[IN_TABLE_MODE][Tokenizer.EOF_TOKEN] = eofInBody;

IM_[IN_TABLE_TEXT_MODE] = {};
IM_[IN_TABLE_TEXT_MODE][Tokenizer.CHARACTER_TOKEN] = characterInTableText;
IM_[IN_TABLE_TEXT_MODE][Tokenizer.NULL_CHARACTER_TOKEN] = nullCharacterInTableText;
IM_[IN_TABLE_TEXT_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = whitespaceCharacterInTableText;
...
IM_[IN_TABLE_TEXT_MODE][Tokenizer.EOF_TOKEN] = tokenInTableText;

IM_[IN_CAPTION_MODE] = {};
IM_[IN_CAPTION_MODE][Tokenizer.CHARACTER_TOKEN] = characterInBody;
IM_[IN_CAPTION_MODE][Tokenizer.NULL_CHARACTER_TOKEN] = nullCharacterInBody;
IM_[IN_CAPTION_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = whitespaceCharacterInBody;
IM_[IN_CAPTION_MODE][Tokenizer.COMMENT_TOKEN] = appendComment;
IM_[IN_CAPTION_MODE][Tokenizer.DOCTYPE_TOKEN] = addMisplacedDoctypeError;
...
IM_[IN_COLUMN_GROUP_MODE][Tokenizer.CHARACTER_TOKEN] =
IM_[IN_COLUMN_GROUP_MODE][Tokenizer.NULL_CHARACTER_TOKEN] = tokenInColumnGroup;
IM_[IN_COLUMN_GROUP_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = insertCharacters;
IM_[IN_COLUMN_GROUP_MODE][Tokenizer.COMMENT_TOKEN] = appendComment;
IM_[IN_COLUMN_GROUP_MODE][Tokenizer.DOCTYPE_TOKEN] = addMisplacedDoctypeError;
...
IM_[IN_COLUMN_GROUP_MODE][Tokenizer.EOF_TOKEN] = eofInBody;

IM_[IN_TABLE_BODY_MODE] = {};
IM_[IN_TABLE_BODY_MODE][Tokenizer.CHARACTER_TOKEN] =
IM_[IN_TABLE_BODY_MODE][Tokenizer.NULL_CHARACTER_TOKEN] =
IM_[IN_TABLE_BODY_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = characterInTable;
IM_[IN_TABLE_BODY_MODE][Tokenizer.COMMENT_TOKEN] = appendComment;
IM_[IN_TABLE_BODY_MODE][Tokenizer.DOCTYPE_TOKEN] = addMisplacedDoctypeError;
...
IM_[IN_TABLE_BODY_MODE][Tokenizer.EOF_TOKEN] = eofInBody;

IM_[IN_ROW_MODE] = {};
IM_[IN_ROW_MODE][Tokenizer.CHARACTER_TOKEN] =
IM_[IN_ROW_MODE][Tokenizer.NULL_CHARACTER_TOKEN] =
IM_[IN_ROW_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = characterInTable;
IM_[IN_ROW_MODE][Tokenizer.COMMENT_TOKEN] = appendComment;
IM_[IN_ROW_MODE][Tokenizer.DOCTYPE_TOKEN] = addMisplacedDoctypeError;
IM_[IN_ROW_MODE][Tokenizer.START_TAG_TOKEN] = startTagInRow;
IM_[IN_ROW_MODE][Tokenizer.END_TAG_TOKEN] = endTagInRow;
IM_[IN_ROW_MODE][Tokenizer.EOF_TOKEN] = eofInBody;

IM_[IN_CELL_MODE] = {};
IM_[IN_CELL_MODE][Tokenizer.CHARACTER_TOKEN] = characterInBody;
IM_[IN_CELL_MODE][Tokenizer.NULL_CHARACTER_TOKEN] = nullCharacterInBody;
IM_[IN_CELL_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = whitespaceCharacterInBody;
IM_[IN_CELL_MODE][Tokenizer.COMMENT_TOKEN] = appendComment;
IM_[IN_CELL_MODE][Tokenizer.DOCTYPE_TOKEN] = addMisplacedDoctypeError;
...
IM_[IN_SELECT_MODE] = {};
IM_[IN_SELECT_MODE][Tokenizer.CHARACTER_TOKEN] = insertCharacters;
IM_[IN_SELECT_MODE][Tokenizer.NULL_CHARACTER_TOKEN] = nullCharacterInSelect;
IM_[IN_SELECT_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = insertCharacters;
IM_[IN_SELECT_MODE][Tokenizer.COMMENT_TOKEN] = appendComment;
IM_[IN_SELECT_MODE][Tokenizer.DOCTYPE_TOKEN] = addMisplacedDoctypeError;
IM_[IN_SELECT_MODE][Tokenizer.START_TAG_TOKEN] = startTagInSelect;
IM_[IN_SELECT_MODE][Tokenizer.END_TAG_TOKEN] = endTagInSelect;
IM_[IN_SELECT_MODE][Tokenizer.EOF_TOKEN] = eofInBody;

IM_[IN_SELECT_IN_TABLE_MODE] = {};
IM_[IN_SELECT_IN_TABLE_MODE][Tokenizer.CHARACTER_TOKEN] = insertCharacters;
IM_[IN_SELECT_IN_TABLE_MODE][Tokenizer.NULL_CHARACTER_TOKEN] = nullCharacterInSelect;
IM_[IN_SELECT_IN_TABLE_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = insertCharacters;
IM_[IN_SELECT_IN_TABLE_MODE][Tokenizer.COMMENT_TOKEN] = appendComment;
IM_[IN_SELECT_IN_TABLE_MODE][Tokenizer.DOCTYPE_TOKEN] = addMisplacedDoctypeError;
...
IM_[IN_SELECT_IN_TABLE_MODE][Tokenizer.EOF_TOKEN] = eofInBody;

IM_[AFTER_BODY_MODE] = {};
IM_[AFTER_BODY_MODE][Tokenizer.CHARACTER_TOKEN] =
IM_[AFTER_BODY_MODE][Tokenizer.NULL_CHARACTER_TOKEN] = tokenAfterBody;
IM_[AFTER_BODY_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = whitespaceCharacterInBody;
IM_[AFTER_BODY_MODE][Tokenizer.COMMENT_TOKEN] = appendCommentToRootHtmlElement;
IM_[AFTER_BODY_MODE][Tokenizer.DOCTYPE_TOKEN] = addMisplacedDoctypeError;
...
IM_[AFTER_BODY_MODE][Tokenizer.EOF_TOKEN] = stopParsing;

IM_[IN_FRAMESET_MODE] = {};
IM_[IN_FRAMESET_MODE][Tokenizer.CHARACTER_TOKEN] =
IM_[IN_FRAMESET_MODE][Tokenizer.NULL_CHARACTER_TOKEN] = characterInFrameset;
IM_[IN_FRAMESET_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = insertCharacters;
IM_[IN_FRAMESET_MODE][Tokenizer.COMMENT_TOKEN] = appendComment;
IM_[IN_FRAMESET_MODE][Tokenizer.DOCTYPE_TOKEN] = addMisplacedDoctypeError;
...
IM_[AFTER_FRAMESET_MODE][Tokenizer.CHARACTER_TOKEN] =
IM_[AFTER_FRAMESET_MODE][Tokenizer.NULL_CHARACTER_TOKEN] = characterAfterFrameset;
IM_[AFTER_FRAMESET_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = insertCharacters;
IM_[AFTER_FRAMESET_MODE][Tokenizer.COMMENT_TOKEN] = appendComment;
IM_[AFTER_FRAMESET_MODE][Tokenizer.DOCTYPE_TOKEN] = addMisplacedDoctypeError;
...
IM_[AFTER_FRAMESET_MODE][Tokenizer.EOF_TOKEN] = stopParsing;

IM_[AFTER_AFTER_BODY_MODE] = {};
IM_[AFTER_AFTER_BODY_MODE][Tokenizer.CHARACTER_TOKEN] = tokenAfterAfterBody;
IM_[AFTER_AFTER_BODY_MODE][Tokenizer.NULL_CHARACTER_TOKEN] = tokenAfterAfterBody;
IM_[AFTER_AFTER_BODY_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = whitespaceCharacterInBody;
IM_[AFTER_AFTER_BODY_MODE][Tokenizer.COMMENT_TOKEN] = appendCommentToDocument;
IM_[AFTER_AFTER_BODY_MODE][Tokenizer.DOCTYPE_TOKEN] = addMisplacedDoctypeError;
IM_[AFTER_AFTER_BODY_MODE][Tokenizer.START_TAG_TOKEN] = startTagAfterAfterBody;
IM_[AFTER_AFTER_BODY_MODE][Tokenizer.END_TAG_TOKEN] = tokenAfterAfterBody;
IM_[AFTER_AFTER_BODY_MODE][Tokenizer.EOF_TOKEN] = stopParsing;

IM_[AFTER_AFTER_FRAMESET_MODE] = {};
IM_[AFTER_AFTER_FRAMESET_MODE][Tokenizer.CHARACTER_TOKEN] =
IM_[AFTER_AFTER_FRAMESET_MODE][Tokenizer.NULL_CHARACTER_TOKEN] = characterAfterAfterFrameset;
IM_[AFTER_AFTER_FRAMESET_MODE][Tokenizer.WHITESPACE_CHARACTER_TOKEN] = whitespaceCharacterInBody;
IM_[AFTER_AFTER_FRAMESET_MODE][Tokenizer.COMMENT_TOKEN] = appendCommentToDocument;
IM_[AFTER_AFTER_FRAMESET_MODE][Tokenizer.DOCTYPE_TOKEN] = addMisplacedDoctypeError;
...
IM_[AFTER_AFTER_FRAMESET_MODE][Tokenizer.EOF_TOKEN] = stopParsing;

//Token handler for the foreign content
var FC_ = {};

FC_[Tokenizer.CHARACTER_TOKEN] = characterInForeignContent;
FC_[Tokenizer.NULL_CHARACTER_TOKEN] = nullCharacterInForeignContent;
FC_[Tokenizer.WHITESPACE_CHARACTER_TOKEN] = insertCharacters;
FC_[Tokenizer.COMMENT_TOKEN] = appendComment;
FC_[Tokenizer.DOCTYPE_TOKEN] = addMisplacedDoctypeError;
...
STIB_[$.SCRIPT] =
STIB_[$.STYLE] =
STIB_[$.TITLE] = startTagInHead;
STIB_[$.BODY] = bodyStartTagInBody;
STIB_[$.FRAMESET] = framesetStartTagInBody;
STIB_[$.ADDRESS] =
STIB_[$.ARTICLE] =
STIB_[$.ASIDE] =
STIB_[$.BLOCKQUOTE] =
...
STIB_[$.SECTION] =
STIB_[$.SUMMARY] =
STIB_[$.UL] = addressStartTagInBody;
STIB_[$.H1] =
STIB_[$.H2] =
STIB_[$.H3] =
STIB_[$.H4] =
STIB_[$.H5] =
STIB_[$.H6] = numberedHeaderStartTagInBody;
STIB_[$.PRE] =
STIB_[$.LISTING] = preStartTagInBody;
STIB_[$.FORM] = formStartTagInBody;
STIB_[$.LI] =
STIB_[$.DD] =
STIB_[$.DT] = listItemStartTagInBody;
STIB_[$.PLAINTEXT] = plaintextStartTagInBody;
STIB_[$.BUTTON] = buttonStartTagInBody;
STIB_[$.A] = aStartTagInBody;
STIB_[$.B] =
STIB_[$.BIG] =
STIB_[$.CODE] =
STIB_[$.EM] =
...
STIB_[$.STRONG] =
STIB_[$.TT] =
STIB_[$.U] = bStartTagInBody;
STIB_[$.NOBR] = nobrStartTagInBody;
STIB_[$.APPLET] =
STIB_[$.MARQUEE] =
STIB_[$.OBJECT] = appletStartTagInBody;
STIB_[$.TABLE] = tableStartTagInBody;
STIB_[$.AREA] =
STIB_[$.BR] =
STIB_[$.EMBED] =
STIB_[$.IMG] =
STIB_[$.KEYGEN] =
STIB_[$.WBR] = areaStartTagInBody;
STIB_[$.INPUT] = inputStartTagInBody;
STIB_[$.PARAM] =
STIB_[$.SOURCE] =
STIB_[$.TRACK] = paramStartTagInBody;
STIB_[$.HR] = hrStartTagInBody;
STIB_[$.IMAGE] = imageStartTagInBody;
STIB_[$.ISINDEX] = isindexStartTagInBody;
STIB_[$.TEXTAREA] = textareaStartTagInBody;
STIB_[$.XMP] = xmpStartTagInBody;
STIB_[$.IFRAME] = iframeStartTagInBody;
STIB_[$.NOEMBED] =
STIB_[$.NOSCRIPT] = noembedStartTagInBody;
STIB_[$.SELECT] = selectStartTagInBody;
STIB_[$.OPTGROUP] =
STIB_[$.OPTION] = optgroupStartTagInBody;
STIB_[$.RP] =
STIB_[$.RT] = rpStartTagInBody;
STIB_[$.MATH] = mathStartTagInBody;
STIB_[$.SVG] = svgStartTagInBody;
STIB_[$.CAPTION] =
STIB_[$.COL] =
STIB_[$.COLGROUP] =
STIB_[$.FRAME] =
...
STIB_[$.TH] =
STIB_[$.THEAD] =
STIB_[$.TR] = captionStartTagInBody;

//End tag in body handlers
var ETIB_ = {};

ETIB_[$.BODY] = bodyEndTagInBody;
ETIB_[$.HTML] = htmlEndTagInBody;
ETIB_[$.ADDRESS] =
ETIB_[$.ARTICLE] =
ETIB_[$.ASIDE] =
ETIB_[$.BLOCKQUOTE] =
...
ETIB_[$.SECTION] =
ETIB_[$.SUMMARY] =
ETIB_[$.UL] = addressEndTagInBody;
ETIB_[$.FORM] = formEndTagInBody;
ETIB_[$.P] = pEndTagInBody;
ETIB_[$.LI] = liEndTagInBody;
ETIB_[$.DD] =
ETIB_[$.DT] = ddEndTagInBody;
ETIB_[$.H1] =
ETIB_[$.H2] =
ETIB_[$.H3] =
ETIB_[$.H4] =
ETIB_[$.H5] =
ETIB_[$.H6] = numberedHeaderEndTagInBody;
ETIB_[$.A] =
ETIB_[$.B] =
ETIB_[$.BIG] =
ETIB_[$.CODE] =
...
ETIB_[$.STRONG] =
ETIB_[$.TT] =
ETIB_[$.U] = aEndTagInBody;
ETIB_[$.APPLET] =
ETIB_[$.MARQUEE] =
ETIB_[$.OBJECT] = appletEndTagInBody;
ETIB_[$.BR] = brEndTagInBody;

//Start tag in table handlers
var STIT_ = {};

STIT_[$.CAPTION] = captionStartTagInTable;
STIT_[$.COLGROUP] = colgroupStartTagInTable;
STIT_[$.COL] = colStartTagInTable;
STIT_[$.TBODY] =
STIT_[$.TFOOT] =
STIT_[$.THEAD] = tbodyStartTagGroupInTable;
STIT_[$.TD] =
STIT_[$.TH] =
STIT_[$.TR] = tdStartTagGroupInTable;
STIT_[$.TABLE] = tableStartTagInTable;
STIT_[$.STYLE] =
STIT_[$.SCRIPT] = startTagInHead;
STIT_[$.INPUT] = inputStartTagInTable;
STIT_[$.FORM] = formStartTagInTable;
...
//Parser
var Parser = exports.Parser = function (html, fragmentContext, treeAdapter) {
...
Parser.prototype.parse = function () {
    ...
    if (this.fragmentContext) {
        ...
        result = this.treeAdapter.createDocumentFragment();
        this._adoptNodes(rootElement, result);
    }
...
Parser.prototype._runParsingLoop = function () {
    while (!this.stopped) {
        ...
        if (this.skipNextNewLine) {
            ...
            if (token.type === Tokenizer.WHITESPACE_CHARACTER_TOKEN && token.ch[0] === '\n') {
                if (token.ch.length === 1)
                    continue;

                token.ch = token.ch.substr(1);
            }
        }
...
Parser.prototype._createElementForToken = function (token, namespaceURI, selfClosingAcknowledged) {
    ...
    return this.treeAdapter.createElement(token.tagName, namespaceURI, token.attrs);
};
...
function addMisplacedDoctypeError(p, token) {
    p._err('Parse error');
}
...
function doctypeInInitialMode(p, token) {
    if (!isValidDoctype(token.name, token.publicId, token.systemId))
        p._err('Parse error');
...
//------------------------------------------------------------------
function nullCharacterInBody(p, token) {
    p._err('Parse error');
}
...
function captionStartTagInBody(p, token) {
    p._err('Parse error');
}
...
function aEndTagInBody(p, token) {
...
function tbodyStartTagGroupInTable(p, token) {
    p.openElements.clearBackToTableContext();
    p._insertElement(token, NS.HTML);
    p.insertionMode = IN_TABLE_BODY_MODE;
}

function tdStartTagGroupInTable(p, token) {
...
//------------------------------------------------------------------
function nullCharacterInTableText(p, token) {
    p._err('Parse error');
}
...
//------------------------------------------------------------------
function nullCharacterInSelect(p, token) {
    p._err('Parse error');
}
...
function startTagInForeignContent(p, token) {
    var valid = isValidForeignContentStartTag(token);

    if (!valid)
        p._err('Parse error');

    if (!valid && !p.fragmentContext) {
        while (p.openElements.currentNamespaceURI !== NS.HTML &&
