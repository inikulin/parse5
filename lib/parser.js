...
ETIB_[$.BLOCKQUOTE] =//10
ETIB_[$.FIGCAPTION] = addressEndTagInBody;//10
...
//OPTIMIZATION: It's ugly, but fast. Integer comparison is much more faster than string comparison.
//So we use tag name length filter here.
