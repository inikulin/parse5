...
Lexer.prototype._consumeNextCh = function () {
...
Lexer.prototype._reconsumeCurrentCh = function (inState) {
    this.state = inState;
...
Lexer.prototype._lookaheadCh = function () {
...
Lexer.prototype._isLookaheadMatchStr = function (str, fromNextCh) {
...
Lexer.prototype._consumeLastLookaheadMatch = function () {
...
Lexer.prototype._consumeCharacterReference = function (additionalAllowedCh) {
    var nextCh = this._lookaheadCh();

    if (nextCh === '\n' || nextCh === '\f' || nextCh === '\t' || nextCh === ' ' ||
        nextCh === '<' || nextCh === '&' || nextCh === EOF || nextCh === additionalAllowedCh) {
        //NOTE: not a character reference. No characters are consumed, and nothing is returned. (This is not an error, either.)
        return;
    }
        ...
        //NOTE: we have a number entity, now we should determine if it's hex or decimal
        var hex = false;
...
_[RCDATA_END_TAG_NAME_STATE] = function (ch) {
    var lexer = this,
        defaultEntry = function () {
            ...
            lexer._reconsumeCurrentCh(RCDATA_STATE);
        };
...
_[RAWTEXT_END_TAG_NAME_STATE] = function (ch) {
    var lexer = this,
        defaultEntry = function () {
            ...
            lexer._reconsumeCurrentCh(RAWTEXT_STATE);
        };
...
_[SCRIPT_DATA_END_TAG_NAME_STATE] = function (ch) {
    var lexer = this,
        defaultEntry = function () {
            ...
            lexer._reconsumeCurrentCh(SCRIPT_DATA_STATE);
        };
...
_[SCRIPT_DATA_ESCAPED_END_TAG_NAME_STATE] = function (ch) {
    var lexer = this,
        defaultEntry = function () {
            ...
            lexer._reconsumeCurrentCh(SCRIPT_DATA_ESCAPED_STATE);
        };
