...
Tokenizer.prototype._emitCharacter = function (ch) {
    ...
    this.pendingCharacterToken.hasNulls = this.pendingCharacterToken.hasNulls || ch === unicode.NULL_CHARACTER;
    this.pendingCharacterToken.hasWhitespaces = this.pendingCharacterToken.hasWhitespaces || isWhitespaceCharacter(ch);
};
