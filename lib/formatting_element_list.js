...
FormattingElementList.prototype._getNoahArkConditionCandidates = function (newElement) {
    ...
    if (this.length >= NOAH_ARK_CAPACITY) {
        var neAttrsLength = this.treeAdapter.getElementAttrs(newElement).length,
        ...
        for (var i = this.length - 1; i >= 0; i--) {
            ...
            var element = entry.element,
                elementAttrs = this.treeAdapter.getElementAttrs(element);
...
FormattingElementList.prototype._ensureNoahArkCondition = function (newElement) {
    ...
    if (cLength) {
        var neAttrs = this.treeAdapter.getElementAttrs(newElement),
...
//Bookmarks
//TODO test it
FormattingElementList.prototype.createBookmark = function (entry) {
    this.bookmark = {
        entry: entry,
        movedAfterEntry: true
    };
};

FormattingElementList.prototype.moveBookmarkAfterEntry = function (entry) {
    this.bookmark.entry = entry;
    this.bookmark.movedAfterEntry = true;
};
