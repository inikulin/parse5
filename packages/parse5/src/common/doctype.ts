import { DOCUMENT_MODE, DocumentMode } from './html.js';
import { DocTypeToken } from '../tokenizer/index.js';
...
export function getDocumentMode(token: DocTypeToken): DocumentMode {
